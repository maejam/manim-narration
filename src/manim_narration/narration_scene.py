...
class NarrationScene(m.Scene, Config):  # type: ignore[misc]
    ...
    short narrations and animations. The easiest way to improve those timings is by
    using a more accurate Aligner. The bookmark timings can also be adjusted with the
    ...
    def set_speech_services(
        ...
        **speech_services: SpeechService,
        ...
        for service in self.speech_services.values():
            service.create_subcaption = self.create_subcaption
    ...
    def add_narration(
        ...
        **subcaption_kwargs: t.Any,
        ...
        if speech_service.create_subcaption:
